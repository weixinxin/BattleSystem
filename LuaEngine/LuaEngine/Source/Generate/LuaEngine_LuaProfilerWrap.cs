...
public class LuaEngine_LuaProfilerWrap
{
	...
	static int GetID(IntPtr L)
	{
		try
		{
			...
			int o = LuaEngine.LuaProfiler.GetID(arg0);
	...
	static int BeginSample(IntPtr L)
	{
		try
		{
			...
			LuaEngine.LuaProfiler.BeginSample(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int EndSample(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			LuaEngine.LuaProfiler.EndSample();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_list(IntPtr L)
	{
		try
		{
			ToLua.PushSealed(L, LuaEngine.LuaProfiler.list);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_list(IntPtr L)
	{
		try
		{
			...
			LuaEngine.LuaProfiler.list = arg0;
			return 0;
		}
		catch (Exception e)
		{
