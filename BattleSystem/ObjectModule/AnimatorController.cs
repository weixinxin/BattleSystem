...
namespace BattleSystem.ObjectModule
{
    ...
    public class AnimatorController
    {
        ...
        {
            mAnimator = ConfigManager.Animator.getRow(animatorID);
            if(mAnimator == null)
            {
                Debug.LogErrorFormat("init animatorController failed! animator id = {0}",animatorID);
            }
        }
        public float speed
        {
        ...
        public bool PlayAnimation(string animationName)
        {
            ...
            if(mAnimation == null)
            {
                Debug.LogErrorFormat("can not find animation {0}",animationName);
                return false;
            }
